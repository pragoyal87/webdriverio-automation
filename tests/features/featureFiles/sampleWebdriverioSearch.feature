Feature: Validate the Search functionality of webdriverIO Site
  ...
  Scenario: As a user, I should get relevant Searc h Results on searching for valid keywords from the webdriverIO Homepage's Search Bar

    Given I am on the webdriverIO homepage
    And I should be on webdriver homepage
